...
import com.plyshka.medtimer.reminders.notificationData.ReminderNotificationPart
...
class NotificationProcessorTest {
    ...
    @BindValue
    val boundMedicineRepository: com.plyshka.medtimer.database.MedicineRepository = testReminderContext.repositoryFakes.medicineRepositoryMock

    @BindValue
    val boundReminderRepository: com.plyshka.medtimer.database.ReminderRepository = testReminderContext.repositoryFakes.reminderRepositoryMock

    @BindValue
    val boundReminderEventRepository: com.plyshka.medtimer.database.ReminderEventRepository = testReminderContext.repositoryFakes.reminderEventRepositoryMock

    @BindValue
    val boundPreferencesDataSource: com.plyshka.medtimer.preferences.PreferencesDataSource = testReminderContext.preferencesDataSourceMock

    @BindValue
    val boundPersistentDataDataSource: com.plyshka.medtimer.preferences.PersistentDataDataSource = testReminderContext.persistentDataDataSourceMock
    ...
    @BindValue
    val boundMedicineRoomDatabase: com.plyshka.medtimer.database.MedicineRoomDatabase = mock()

    @BindValue
    val boundMedicineDao: com.plyshka.medtimer.database.MedicineDao = mock()

    @BindValue
    val boundReminderDao: com.plyshka.medtimer.database.ReminderDao = mock()

    @BindValue
    val boundReminderEventDao: com.plyshka.medtimer.database.ReminderEventDao = mock()

    @BindValue
    val boundTagDao: com.plyshka.medtimer.database.TagDao = mock()

    @BindValue
    val boundTagRepository: com.plyshka.medtimer.database.TagRepository = mock()

    @BindValue
    val boundDatabaseManager: com.plyshka.medtimer.database.DatabaseManager = mock()
