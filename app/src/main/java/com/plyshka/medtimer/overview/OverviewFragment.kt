...
import com.plyshka.medtimer.MedicineViewModel
import com.plyshka.medtimer.OnFragmentReselectedListener
import com.plyshka.medtimer.OptionsMenu
...
import com.plyshka.medtimer.overview.actions.ActionsFactory
import com.plyshka.medtimer.overview.actions.ActionsMenu
import com.plyshka.medtimer.overview.actions.MultipleActions
            ...
            defaultViewModelCreationExtras.withCreationCallback<OverviewViewModel.Factory> { factory ->
                factory.create(
                    medicineViewModel.getLiveReminderEvents(
                        ...
                        com.plyshka.medtimer.database.statusValuesWithoutDelete
                    ),
        ...
        override fun onActionItemClicked(mode: ActionMode?, item: MenuItem?): Boolean {
            if (actionsMenu != null) {
                if (item?.itemId == R.id.selectAll) {
                    ...
                    val button = com.plyshka.medtimer.overview.actions.Button.fromId(item?.itemId ?: return false)
                    lifecycleScope.launch {
