...
import com.plyshka.medtimer.BuildConfig
...
class TextInputDialogBuilder(
    ...
    fun show() {
        ...
        val dialog = MaterialAlertDialogBuilder(context)
            ...
            .setPositiveButton(com.plyshka.medtimer.R.string.ok) { _: DialogInterface?, _: Int ->
                editText.text?.let { textSink?.consumeText(it.toString()) }
            }
            .setNegativeButton(com.plyshka.medtimer.R.string.cancel) { dialog: DialogInterface, _: Int ->
                dialog.dismiss()
            }
